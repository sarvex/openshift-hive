...
replace (
	...
	sigs.k8s.io/cluster-api-provider-aws => github.com/openshift/cluster-api-provider-aws 63025f8fdfc1 // Indirect dependency through MAO from cluster API providers
